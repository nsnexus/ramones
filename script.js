...
document.getElementById('searchBtn').onclick=()=>{query=document.getElementById('searchInput').value;renderProducts();document.getElementById('drops').scrollIntoView({behavior:'smooth'})}; document.getElementById('searchInput').addEventListener('input',e=>{query=e.target.value;renderProducts()});
